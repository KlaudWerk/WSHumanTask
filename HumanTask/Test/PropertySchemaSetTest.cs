...
namespace HumanTask.Test
{
    ...
    public class PropertySchemaSetTest
    {
        ...
        {
            Mock<PropertySchemaSetBase> mock=new Mock<PropertySchemaSetBase>(new PropertySchemaFactory()) {CallBase = true};
            mock.Protected().SetupGet<IDictionary<string, IValueSchema<object>>>("SchemaStore").Returns(_storage);
            return mock.Object;
        }
    }
}

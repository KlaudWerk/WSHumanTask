...
{
    [TestFixture]
    public class HibernatePropertySetTests : ValueSetCollectionTest
    {
        ...
        public void FixtureSetUp()
        {
            Configuration c = new Configuration().Proxy(
                ...
                .DataBaseIntegration(d =>
                                         {
                                             d.Dialect<MsSql2008BlobDialect>();
        ...
        {
            return new HibernatePropertySetCollection(new PropertySchemaFactory(), _sessionFactory, Guid.NewGuid());
        }
    }
}
